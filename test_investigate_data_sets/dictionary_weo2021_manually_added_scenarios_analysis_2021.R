...
informant_pp <-
  create_informant(
    ...
    label = "Scenario analysis input from **Scenarios_AnalysisInput_2021.csv** PACTA prewrangled, weo 2021 manually added 📦."
  ) %>%
  info_columns(
    columns = "year",
...
get_informant_report(informant_pp, title = "Data Dictionary") |> export_report(filename = affix_datetime
                                                                               ("./test_investigate_data_sets/dictionary_weo2021_manually_added_scenarios_analysis_input_2021.html"))
